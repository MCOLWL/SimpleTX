...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA7     ------> ADC2_IN4
    */
    GPIO_InitStruct.Pin = AM1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(AM1_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PB0     ------> ADC3_IN12
    */
    GPIO_InitStruct.Pin = MIC_SECONDARY_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(MIC_SECONDARY_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PA9     ------> ADC5_IN2
    */
    GPIO_InitStruct.Pin = VBAT_Pin|STM_5V_DET_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA7     ------> ADC2_IN4
    */
    HAL_GPIO_DeInit(AM1_GPIO_Port, AM1_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PB0     ------> ADC3_IN12
    */
    HAL_GPIO_DeInit(MIC_SECONDARY_GPIO_Port, MIC_SECONDARY_Pin);
  ...
  /* USER CODE END ADC5_MspDeInit 0 */
    ...
    PA9     ------> ADC5_IN2
    */
    HAL_GPIO_DeInit(GPIOA, VBAT_Pin|STM_5V_DET_Pin);
...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC2_MspInit 0 */
    ...
    PA6     ------> DAC2_OUT1
    */
    GPIO_InitStruct.Pin = MODULUJACY_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(MODULUJACY_GPIO_Port, &GPIO_InitStruct);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC2_MspDeInit 0 */
    ...
    PA6     ------> DAC2_OUT1
    */
    HAL_GPIO_DeInit(MODULUJACY_GPIO_Port, MODULUJACY_Pin);
...
void HAL_OPAMP_MspInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  /* USER CODE END OPAMP5_MspInit 0 */
    ...
    PB15     ------> OPAMP5_VINM0
    */
    GPIO_InitStruct.Pin = GPIO_PIN_14|MIC_PRIMARY_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  /* USER CODE END OPAMP5_MspDeInit 0 */
    ...
    PB15     ------> OPAMP5_VINM0
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_14|MIC_PRIMARY_Pin);
